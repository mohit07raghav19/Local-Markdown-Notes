  ...
  function togglePreview() {
    ...
    if (toggleViewBtn) {
      toggleViewBtn.innerHTML = isPreviewMode
        ...
        : 'Preview <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12z" stroke="#d4d4d4" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path><circle cx="12" cy="12" r="3" stroke="#d4d4d4" stroke-width="1.2"></circle></svg>';
    }
  }
